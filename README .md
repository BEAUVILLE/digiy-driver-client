...
📱 UX Mobile-first
Principes clés
Boutons tactiles larges (min 44px hauteur)
Police lisible (min 16px pour éviter zoom iOS)
Formulaire minimal (maximum 3 champs par page)
Clavier adapté (type="tel" pour numéro)
...
Le bookingId est bien passé dans l'URL
Le numéro est bien pré-rempli
La mise à jour converted_to_account s'exécute
